...
static const u16 sHoennToNationalOrder[HOENN_DEX_COUNT - 1] =
{
    ...
    HOENN_TO_NATIONAL(KOALEAF),
    HOENN_TO_NATIONAL(EUCOALA),
    HOENN_TO_NATIONAL(KOALEAF),
    HOENN_TO_NATIONAL(PYROO),
    HOENN_TO_NATIONAL(PYROBY),
    HOENN_TO_NATIONAL(WALLARO),
    HOENN_TO_NATIONAL(PATTLE),
    HOENN_TO_NATIONAL(PLATTAIL),
    HOENN_TO_NATIONAL(TSUNAMIC),
    HOENN_TO_NATIONAL(MARMUNK),
    HOENN_TO_NATIONAL(MARPINE),
    HOENN_TO_NATIONAL(FLICKADEE),
    HOENN_TO_NATIONAL(FLOCKATEAL),
    HOENN_TO_NATIONAL(FLOQUILA),
    HOENN_TO_NATIONAL(SOLARVA),
    HOENN_TO_NATIONAL(SOLELL),
    HOENN_TO_NATIONAL(SOLAFLY),
    HOENN_TO_NATIONAL(GLOWURM),
    HOENN_TO_NATIONAL(PSYCOON),
    HOENN_TO_NATIONAL(LUNAFLY),
    HOENN_TO_NATIONAL(PLUPPY),
    HOENN_TO_NATIONAL(HERMOG),
    HOENN_TO_NATIONAL(PIPUN),
    HOENN_TO_NATIONAL(PIPAWK),
    HOENN_TO_NATIONAL(PEREGRANDE),
    HOENN_TO_NATIONAL(FLUFFOON),
    HOENN_TO_NATIONAL(AVIROON),
    HOENN_TO_NATIONAL(LEMAUL),
    HOENN_TO_NATIONAL(FERAMUR),
    HOENN_TO_NATIONAL(MENIPENNY),
    HOENN_TO_NATIONAL(WOMBOL),
    HOENN_TO_NATIONAL(BEEZIL),
    HOENN_TO_NATIONAL(GALVESPA),
    HOENN_TO_NATIONAL(SONNEST),
    HOENN_TO_NATIONAL(CANAROSA),
    HOENN_TO_NATIONAL(SYGNAL),
    HOENN_TO_NATIONAL(SWANAMI),
    HOENN_TO_NATIONAL(TAEGLE),
    HOENN_TO_NATIONAL(TALONITE),
    HOENN_TO_NATIONAL(SHOBASH),
    HOENN_TO_NATIONAL(BURRASH),
    HOENN_TO_NATIONAL(PSIBIAN),
    HOENN_TO_NATIONAL(GORPHIBIUS),
    HOENN_TO_NATIONAL(TOTTEM),
    HOENN_TO_NATIONAL(TOTOTEM),
    HOENN_TO_NATIONAL(TOTOWER),
    HOENN_TO_NATIONAL(INFASTEGO),
    HOENN_TO_NATIONAL(LETHASTEGO),
    HOENN_TO_NATIONAL(ANKYLO),
    HOENN_TO_NATIONAL(ANKYLEDGE),
    HOENN_TO_NATIONAL(RODA),
    HOENN_TO_NATIONAL(GWINNA),
    HOENN_TO_NATIONAL(GLOLI),
    HOENN_TO_NATIONAL(BIZZAP),
    HOENN_TO_NATIONAL(TELAQUA),
    HOENN_TO_NATIONAL(TELAZURE),
    HOENN_TO_NATIONAL(CARDA),
    HOENN_TO_NATIONAL(CARDIAL),
    HOENN_TO_NATIONAL(CARDASTRA),
    HOENN_TO_NATIONAL(TINJAY),
    HOENN_TO_NATIONAL(FROSTREL),
    HOENN_TO_NATIONAL(MEERCUNE),
    HOENN_TO_NATIONAL(MEERKLAW),
    HOENN_TO_NATIONAL(LEEF),
    HOENN_TO_NATIONAL(BIGLEEF),
    HOENN_TO_NATIONAL(DINGROWL),
    HOENN_TO_NATIONAL(VERLINE),
    HOENN_TO_NATIONAL(VERDEGUAR),
    HOENN_TO_NATIONAL(HARPURE),
    HOENN_TO_NATIONAL(PHAIRIS),
    HOENN_TO_NATIONAL(SPRIMA),
    HOENN_TO_NATIONAL(DRYLAC),
    HOENN_TO_NATIONAL(VIPERRA),
    HOENN_TO_NATIONAL(VOLTERRA),
    HOENN_TO_NATIONAL(GREETLE),
    HOENN_TO_NATIONAL(TAMACHROA),
    HOENN_TO_NATIONAL(TARSEER),
    HOENN_TO_NATIONAL(TARSAYER),
    HOENN_TO_NATIONAL(TRICETRA),
    HOENN_TO_NATIONAL(TRIOCCA),
    HOENN_TO_NATIONAL(PETIMITE),
    HOENN_TO_NATIONAL(STALACLAW),
    HOENN_TO_NATIONAL(EXPLOMB),
    HOENN_TO_NATIONAL(NUCLOMB),
};
