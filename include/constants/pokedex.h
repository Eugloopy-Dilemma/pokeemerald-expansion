...
enum {
    ...
    NATIONAL_DEX_KOALEAF,
    NATIONAL_DEX_EUCOALA,
    NATIONAL_DEX_KOALYPTUS,
    NATIONAL_DEX_PYROO,
    NATIONAL_DEX_PYROBY,
    NATIONAL_DEX_WALLARO,
    NATIONAL_DEX_PATTLE,
    NATIONAL_DEX_PLATTAIL,
    NATIONAL_DEX_TSUNAMIC,
    NATIONAL_DEX_MARMUNK,
    NATIONAL_DEX_MARPINE,
    NATIONAL_DEX_FLICKADEE,
    NATIONAL_DEX_FLOCKATEAL,
    NATIONAL_DEX_FLOQUILA,
    NATIONAL_DEX_SOLARVA,
    NATIONAL_DEX_SOLELL,
    NATIONAL_DEX_SOLAFLY,
    NATIONAL_DEX_GLOWURM,
    NATIONAL_DEX_PSYCOON,
    NATIONAL_DEX_LUNAFLY,
    NATIONAL_DEX_PLUPPY,
    NATIONAL_DEX_HERMOG,
    NATIONAL_DEX_PIPUN,
    NATIONAL_DEX_PIPAWK,
    NATIONAL_DEX_PEREGRANDE,
    NATIONAL_DEX_FLUFFOON,
    NATIONAL_DEX_AVIROON,
    NATIONAL_DEX_LEMAUL,
    NATIONAL_DEX_FERAMUR,
    NATIONAL_DEX_MENIPENNY,
    NATIONAL_DEX_WOMBOL,
    NATIONAL_DEX_BEEZIL,
    NATIONAL_DEX_GALVESPA,
    NATIONAL_DEX_SONNEST,
    NATIONAL_DEX_CANAROSA,
    NATIONAL_DEX_SYGNAL,
    NATIONAL_DEX_SWANAMI,
    NATIONAL_DEX_TAEGLE,
    NATIONAL_DEX_TALONITE,
    NATIONAL_DEX_SHOBASH,
    NATIONAL_DEX_BURRASH,
    NATIONAL_DEX_PSIBIAN,
    NATIONAL_DEX_GORPHIBIUS,
    NATIONAL_DEX_TOTTEM,
    NATIONAL_DEX_TOTOTEM,
    NATIONAL_DEX_TOTOWER,
    NATIONAL_DEX_INFASTEGO,
    NATIONAL_DEX_LETHASTEGO,
    NATIONAL_DEX_ANKYLO,
    NATIONAL_DEX_ANKYLEDGE,
    NATIONAL_DEX_RODA,
    NATIONAL_DEX_GWINNA,
    NATIONAL_DEX_GLOLI,
    NATIONAL_DEX_BIZZAP,
    NATIONAL_DEX_TELAQUA,
    NATIONAL_DEX_TELAZURE,
    NATIONAL_DEX_CARDA,
    NATIONAL_DEX_CARDIAL,
    NATIONAL_DEX_CARDASTRA,
    NATIONAL_DEX_TINJAY,
    NATIONAL_DEX_FROSTREL,
    NATIONAL_DEX_MEERCUNE,
    NATIONAL_DEX_MEERKLAW,
    NATIONAL_DEX_LEEF,
    NATIONAL_DEX_BIGLEEF,
    NATIONAL_DEX_DINGROWL,
    NATIONAL_DEX_VERLINE,
    NATIONAL_DEX_VERDEGUAR,
    NATIONAL_DEX_HARPURE,
    NATIONAL_DEX_PHAIRIS,
    NATIONAL_DEX_SPRIMA,
    NATIONAL_DEX_DRYLAC,
    NATIONAL_DEX_VIPERRA,
    NATIONAL_DEX_VOLTERRA,
    NATIONAL_DEX_GREETLE,
    NATIONAL_DEX_TAMACHROA,
    NATIONAL_DEX_TARSEER,
    NATIONAL_DEX_TARSAYER,
    NATIONAL_DEX_TRICETRA,
    NATIONAL_DEX_TRIOCCA,
    NATIONAL_DEX_PETIMITE,
    NATIONAL_DEX_STALACLAW,
    NATIONAL_DEX_EXPLOMB,
    NATIONAL_DEX_NUCLOMB,
};
...
#define JOHTO_DEX_COUNT     NATIONAL_DEX_CELEBI
    ...
    #define NATIONAL_DEX_COUNT  NATIONAL_DEX_NUCLOMB
...
enum {
    ...
    HOENN_DEX_BURRASH,
    HOENN_DEX_PSIBIAN,
    HOENN_DEX_GORPHIBIUS,
    HOENN_DEX_TOTTEM,
    HOENN_DEX_TOTOTEM,
    HOENN_DEX_TOTOWER,
    HOENN_DEX_INFASTEGO,
    HOENN_DEX_LETHASTEGO,
    HOENN_DEX_ANKYLO,
    HOENN_DEX_ANKYLEDGE,
    HOENN_DEX_RODA,
    HOENN_DEX_GWINNA,
...
#define HOENN_DEX_COUNT (HOENN_DEX_NUCLOMB + 1)
